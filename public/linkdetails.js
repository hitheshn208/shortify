...
async function updateOriginalUrl(newUrl) {
    ...
    try {
        const response = await fetch(`/user/${urlCode}/edit`, {
            method: 'PATCH',
            headers: {
...
async function updateSecuritySettings(isProtected, password) {
    ...
    const res = await fetch(`/user/${urlCode}/security`, {
        method : "PATCH",
        headers: { 
            "Content-type" : "application/json"
        },
...
async function resetClicks() {
    ...
    try {
        const response = await fetch(`/user/${urlCode}/reset-clicks`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function deleteLink() {
    ...
    try {
        const response = await fetch(`/user/${urlCode}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
            }
